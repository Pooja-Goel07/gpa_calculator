...
class _HomePageCalc extends State<HomePageCalc> {
  ...
  double calculateGpa() {
    ...
    double safeGradeValue(String? grade) {
      return gradevalue[grade] ?? 0.0;
    }

    double safeCreditValue(double? credit) {
      if (credit == 1 ||
          credit == 1.5 ||
          credit == 2 ||
          credit == 3 ||
    ...
    double nume = safeCreditValue(credits01) * safeGradeValue(grade01) +
        safeCreditValue(credits02) * safeGradeValue(grade02) +
        safeCreditValue(credits03) * safeGradeValue(grade03) +
        safeCreditValue(credits04) * safeGradeValue(grade04) +
        safeCreditValue(credits05) * safeGradeValue(grade05) +
        safeCreditValue(credits06) * safeGradeValue(grade06) +
        safeCreditValue(credits07) * safeGradeValue(grade07) +
        safeCreditValue(credits08) * safeGradeValue(grade08) +
        safeCreditValue(credits09) * safeGradeValue(grade09) +
        safeCreditValue(credits10) * safeGradeValue(grade10);
    double den = safeCreditValue(credits01) +
        safeCreditValue(credits02) +
        safeCreditValue(credits03) +
        safeCreditValue(credits04) +
        safeCreditValue(credits05) +
        safeCreditValue(credits06) +
        safeCreditValue(credits07) +
        safeCreditValue(credits08) +
        safeCreditValue(credits09) +
        safeCreditValue(credits10);
    if (den == 0.0) {
      result = 0.0;
    } else {
      result = nume / den;
                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: DropdownButton<String>(
                                underline: SizedBox(),
                                dropdownColor:
                                    const Color.fromARGB(255, 88, 58, 149),
                                padding:
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              elevation: 20,
                              backgroundColor:
                                  const Color.fromARGB(255, 48, 18, 87)),
                          child: Padding(
                        ...
                        Container(
                          ...
                          height: 300,
                          decoration: BoxDecoration(
                              color: const Color.fromARGB(255, 48, 18, 87),
                              borderRadius: BorderRadius.circular(20)),
                          child: Center(
                              child: Text(
                            "GPA = ${result.toStringAsFixed(2)}",
